...
public class CriteriaActivityFragment extends FragmentActivity implements CriteriaFragment.OnListItemClickedListener{
    ...
    private void turnPage(int listViewNumber) {
    	if(listViewNumber >= 2) {
    		Intent i = new Intent(CriteriaActivityFragment.this, CriteriaSummaryActivity.class);
    		//potentially pass the info using key/value argments eg...
    		//i.putExtra(key, value);
    		//retrieve on next activity via
    		//Intent intent = getIntent();
    		//String value = intent.getStringExtra("key");
    		CriteriaActivityFragment.this.startActivity(i);
    	}
