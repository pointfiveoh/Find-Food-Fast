...
public class PlaceFinderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (gps.canGetLocation()) {
            ...
            alert.showAlertDialog(PlaceFinderActivity.this, "GPS Status",
        ...
        // Getting listview
        lv = (ListView) findViewById(R.id.placeslistview);
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String reference = ((TextView) view.findViewById(R.id.placereference)).getText().toString();
    ...
    class LoadPlaces extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(PlaceFinderActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(status.equals("OK")){
                        ...
                        // Zero results found
                        alert.showAlertDialog(PlaceFinderActivity.this, "Near Places",
                                "Sorry no places found. Try to change the types of places",
                                false);
                    }
                    else if(status.equals("UNKNOWN_ERROR"))
                    {
                        alert.showAlertDialog(PlaceFinderActivity.this, "Places Error",
